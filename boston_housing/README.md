...
Se você ainda não tem o Python instalado, é altamente recomendado que instale a distribuição Anaconda, que já tem os pacotes acima incluídos. Certifique-se de selecionar o instalador Python 3.x.
